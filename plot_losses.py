...
fig, ax = plt.subplots()
ax.plot(training_losses[::100], label='Train', color='indianred', marker='x')
ax.plot(validation_losses, label='Validation', color='lightseagreen', marker='+')
ax.set_xlabel("Iteration")
ax.set_ylabel("Cross-Entropy Loss")
ax.grid(True, color='gainsboro')
ax.set_title("Model 1: Train and Validation Losses every 100th iteration")
ax.legend()
plt.savefig("images/model1_train_val_losses.png")
plt.show()
